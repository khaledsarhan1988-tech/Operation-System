...
- **جذر تلوّث `group_renames`:** إصلاح `driveSync` ليتوقف عن إعادة تسجيل التسميات + توليد الحواف المعكوسة (المسار المنطقي يحمي التقارير حاليًا).
