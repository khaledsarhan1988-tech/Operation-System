...
- **تقسيمة KPIs + اختيارها + قفل الشهر (2026-06-08):**
  ...
  - **اختيار (الجزء 2):** عمود "KPIs" في المرتبات → مودال بـ3 checkboxes (بمبالغ نظام المدرّب)؛ المختار يتضاف للصافي. **اختيار يدوي**، مخزّن لكل (مدرّب+شهر) في `trainer_kpi_awards` (upsert). على أول صف للمدرّب بس. `net = base + extraPay − ded + outOfDuty + kpi`.
