...
import TrainerRecruitment from './pages/admin/TrainerRecruitment';
import TrainerOrgChart from './pages/admin/TrainerOrgChart';
...
const router = createBrowserRouter([
  ...
  // still needs the specific grant in extra_pages (admins always pass).
  {
    ...
    children: [
      { path: 'trainer-utilization',    element: <PrivateRoute requirePage="trainer-utilization"><TrainerUtilization /></PrivateRoute> },
      { path: 'trainer-dashboard',      element: <PrivateRoute requirePage="trainer-dashboard"><TrainerUtilizationDashboard /></PrivateRoute> },
      { path: 'find-available-trainer', element: <PrivateRoute requirePage="find-available-trainer"><TrainerAvailabilityFinder /></PrivateRoute> },
      { path: 'trainer-work-history',   element: <PrivateRoute requirePage="trainer-work-history"><TrainerWorkHistory /></PrivateRoute> },
      { path: 'phone-call-gap',         element: <PrivateRoute requirePage="phone-call-gap"><PhoneCallGap /></PrivateRoute> },
  ...
  // ── Leader routes ─────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'users',                        element: <PrivateRoute superAdmin><UserManagement /></PrivateRoute> },
  ...
  // ── Admin routes ──────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'reports/trainer-recruitment',    element: <TrainerRecruitment /> },
      { path: 'reports/trainer-org-chart',      element: <TrainerOrgChart /> },
      ...
      { path: 'reports/customer-services',    element: <PrivateRoute requireManagement="Customer Services"><SystemReports /></PrivateRoute> },
      { path: 'reports/education',            element: <EducationReports /> },
      ...
      { path: 'sales-register',                element: <PrivateRoute requireManagement="Customer Services"><ClientSalesRegister /></PrivateRoute> },
    ],
  },
